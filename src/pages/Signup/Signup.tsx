    ...
    return (
        <div className="bg-black h-screen w-screen flex flex-col justify-center items-center">
            <div className="bg-light-gray w-1/3 overflow-y-auto px-20 py-16 rounded-lg text-white text-lg font-poppins">
                <p className="text-center text-2xl font-semibold">Create KBL Account</p>
                ...
                <p className="text-white text-md mt-5">Have an account? <Link to="/login" className="text-light-blue hover:underline hover:text-blue-300">Login</Link></p>
            </div>
